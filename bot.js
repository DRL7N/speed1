...
const devs = ['383394687349948426','431844030587076619'];
var prefix = "!";
const adminprefix = "!"
...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`https://www.twitch.tv/tee`);
    }, ms);
...
if(message.content.startsWith(prefix + "stopdisco")) {
  ...
  message.reply(`لا يمكنك يجب ان تكون صاحب السيرفر`);
  }
}
...
client.on("ready", () => {
    client.user.setPresence({ game: { name: `Dance` }, type: 0 });
